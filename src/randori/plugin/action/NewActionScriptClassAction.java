...

{
    ...
    protected PsiElement doCreate(PsiDirectory dir, String className,
        ...
        if (fromTemplate.getFileType().getDefaultExtension().endsWith("as")) {
    ...
    protected void buildDialog(Project project, PsiDirectory directory, CreateFileFromTemplateDialog.Builder builder) {
        ...
        for (FileTemplate template : FileTemplateManager.getInstance().getAllTemplates()) {
            ...
            if (fileType.getDefaultExtension().endsWith("as") && JavaDirectoryService.getInstance().getPackage(directory) != null) {
    ...
    protected boolean isAvailable(DataContext dataContext) {
        return super.isAvailable(dataContext) && ProjectUtils.hasRandoriModuleType(LangDataKeys.PROJECT.getData(dataContext));
    }
}
