...
public class ProjectUtils {
    ...
    public static boolean hasRandoriModuleType(Project project) {
        ...
        for (Module module : modules)
            if (ModuleType.get(module).equals(RandoriWebModuleType.getInstance()) || ModuleType.get(module).equals(RandoriLibraryModuleType.getInstance()))
                return true;
    ...
    public static boolean isRandoriWebModule(Module module) {
